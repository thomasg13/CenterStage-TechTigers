...
public class RedAutoOld extends LinearOpMode {
        ...
        switch(teamProp) {
            case 1:
                ...
                toSecondWayPoint = drive.trajectoryBuilder(toFirstWaypoint.end())
                        .lineToLinearHeading(new Pose2d(-9, 27, Math.toRadians(90)))
                        .build();
                break;
            case 2:
                toFirstWaypoint = drive.trajectoryBuilder(startingPose)
            ...
            case 3:
                toFirstWaypoint = drive.trajectoryBuilder(startingPose)
                        .lineToLinearHeading(new Pose2d(15, 26, Math.toRadians(90)))
                        .build();
