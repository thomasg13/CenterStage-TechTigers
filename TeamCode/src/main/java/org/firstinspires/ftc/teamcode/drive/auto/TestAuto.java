...
public class TestAuto extends LinearOpMode {//far auto

    private SampleMecanumDrive drive;
    private int teamProp;
    private Pose2d startingPose = new Pose2d(-35, -64, Math.toRadians(90)); // Set your starting position
    ...
    public void runOpMode() {
        ...
        Trajectory toFirstWaypoint = drive.trajectoryBuilder(startingPose)
                .splineTo(new Vector2d(24, -24), Math.toRadians(90)) // Example waypoint
                .build();
