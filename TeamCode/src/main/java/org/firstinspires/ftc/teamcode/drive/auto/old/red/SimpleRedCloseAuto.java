...
public class SimpleRedCloseAuto extends LinearOpMode {
    ...
    private Pose2d startingPose = new Pose2d(12, -63.5, Math.toRadians(90)); // Set your starting position
    ...
    public void runOpMode() {
        ...
        pathingToStage = drive.trajectoryBuilder(toDropPixelPosition.end())
                //.strafeRight(12)
                .lineToLinearHeading(new Pose2d(54, -60, Math.toRadians(90)))
                .build();
